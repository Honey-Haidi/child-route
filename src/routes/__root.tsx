...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SafeRide — live school transport tracking" },
      {
        name: "description",
        content: "Live school van tracking for parents, drivers and schools.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "SafeRide" },
    ],
    links: [
      {
        rel: "stylesheet",
